  ...
  customOperations: {
    ...
    'config update': {
      ...
      description:
        ...
        'Use --id <group-id> and any of: --provider, --model, --effort, --speed, --image-tag, --assistant-name, --max-messages-per-prompt, --cli-scope, --activity-journal, --history-mode, ' +
      ...
      handler: async (args) => {
        ...
        if (args['activity-journal'] !== undefined || args.activity_journal !== undefined) {
          const journal = (args['activity-journal'] ?? args.activity_journal) as string;
        ...
        if (Object.keys(updates).length === 0) {
          throw new Error(
            'Nothing to update — provide at least one of: --provider, --model, --effort, --speed, --image-tag, --assistant-name, --max-messages-per-prompt, --cli-scope, --activity-journal, --history-mode, --timezone',
          );
        }
