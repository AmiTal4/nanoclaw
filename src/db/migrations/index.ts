...
// Upstream shipped these as 020/021/022, and its later approvals-instance /
// host-coordination / container-config-speed as 023/024/025; this fork had
// already taken those numbers, so upstream's are renumbered on the way in.
// Applied-state is keyed on `name`, not `version`, so the renumber is
// invisible to any DB that already ran them.
...
import { migration026 } from './026-approvals-instance.js';
import { migration027 } from './027-host-coordination.js';
import { migration028 } from './028-container-config-speed.js';
